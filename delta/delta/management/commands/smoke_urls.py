...
STAFF_ONLY = {
    ...
    "backoffice_courses:lesson-delete", "backoffice_courses:presentation-edit",
    "backoffice_courses:notes-document-edit",
    "backoffice_courses:script-create",
...
PARAM_SOURCES = {
    ...
    "academy:lesson-notes-document": (False, lambda: _kw(_first("academy.Lesson", notes_document__isnull=False), pk="pk")),
    "academy:lesson-notes-pdf": (False, lambda: _kw(_first("academy.Lesson", notes_document__isnull=False), pk="pk")),
    ...
    "backoffice_courses:presentation-edit": (False, lambda: _kw(_first("academy.Lesson"), pk="pk")),
    "backoffice_courses:notes-document-edit": (False, lambda: _kw(_first("academy.Lesson"), pk="pk")),
